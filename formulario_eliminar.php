...
<body>
    ...
    <h1>Eliminacion de Personas</h1>
    <form action="eliminar_registro.php" name="form1" method="get">
        <table border="0" align="center">
            ...
            <tr>
                ...
                <td align="center"><input type="reset" name="borrar" id="borrar" value="Limpiar"></td>
            </tr>
        </table>
    </form>
</body>
